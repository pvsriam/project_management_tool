document.addEventListener("DOMContentLoaded", function () {
    ...
    const allowedNames = ["Sri Ram", "Bathrinathan", "Surya Prakash", "Aravind", "Koushik"];
    ...
    form.addEventListener("submit", function (event) {
        ...
        newTask.innerHTML = `
            <div class="task-info">
                ...
                <p class="task-assign">Assigned by: ${assignedBy}</p>
            </div>
            ...
            <div class="comment-section">
                ...
                <select class="commenter-names">
                    ...
                    <option value="Bathrinathan">Bathrinathan</option>
        ...
        startTaskButton.addEventListener("click", function () {
            ...
            if (assignedTo && allowedNames.includes(assignedTo)) {
                ...
                newTask.querySelector(".task-assign").textContent = `Assigned by: ${assignedBy} | Assigned to: ${assignedTo}`;
